...
<body>
    ...
    <div class="header-container">
        ...
        <img src="images/Western_Mindanao_State_University.png" alt="WMSU Logo" class="header-logo">
    ...
    <div class="print-button-container">
        <button class="print-button" onclick="window.print()">Print Record</button>
    </div>
    ...
    <div class="section-container">
        ...
        <div class="section-content pi-section">
            ...
            <div class="personal-info-grid" style="width: 100%;">
                <table>
                    <tr>
                        <td>Name:</td>
                    ...
                    if ($userType === 'Senior High School') {
                        ...
                        echo '<td><span class="view-only-text">' . htmlspecialchars($departmentFullName) . '</span></td>';
                        echo '</tr><tr>';

                        echo '</tr><tr>';
                        echo '<td>Course:</td>';
                        echo '<td><span class="view-only-text">' . htmlspecialchars($courseName) . '</span></td>';
                        ...
                        echo '<td><span class="view-only-text">' . htmlspecialchars($grading_quarter ?? '-') . '</span></td>';
                    ...
                    <tr>
                        <td colspan="4">Provincial Address (if applicable): <span class="view-only-text"><?php echo htmlspecialchars(string: $provincial_address); ?></span></td>
                    </tr>
                    <tr>
                        <td colspan="4">
                            <table>
        ...
        <div class="section-content">
            ...
            <div class="checkbox-group">
                ...
                foreach ($comorbid_conditions as $key => $label):
                    ...
                    if ($lower_key === 'allergies' && in_array($lower_key, $illnesses)) {
    ...
    <script>
        // Optional: Add confirmation before printing
        document.querySelector('.print-button').addEventListener('click', function() {
            if (confirm('Print this patient record?')) {
                window.print();
            }
        });
    </script>
