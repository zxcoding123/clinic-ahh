    ...
    LIMIT 1";
        ...
        $menstrual_symptoms = !empty($medical_info['menstrual_symptoms'])
            ...
            : [];
                   ...
                   // Turn illnesses string into map: condition => extra info
        $menstrual_symptoms_map = [];
        if (!empty($medical_info['menstrual_symptoms'])) {
            $items = explode(',', $medical_info['menstrual_symptoms']);
            foreach ($items as $item) {
                $parts = explode(':',  $item, 2);
                $condition = strtolower(trim($parts[0]));
                $extra = isset($parts[1]) ? trim($parts[1]) : '';
                $menstrual_symptoms_map[$condition] = $extra;
            }
        }
        ...
        $grading_quarter_patient = $patient_data['grading_quarter'];
        $track_strand_patient = $patient_data['track_strand'];
        $section_patient = $patient_data['section'];
...
<body>
    ...
    <div id="printableArea">
        ...
        <table class="main-table">
            ...
            <tr>
                ...
                ?>
                    <td colspan="3"><b>Age: </b> <?php echo $age ?></td>
                    <td><b>Sex: </b> <?php echo ucfirst($sex) ?></td>
                <?php } elseif ($userType == 'College' || $userType == 'Incoming Freshman') { ?>
                    <td><b>Age: </b> <?php echo $age ?></td>
                    <td><b>Sex: </b> <?php echo ucfirst($sex) ?></td>
                    <td><b>Course: </b> <?php echo $courseName ?></td>
                    <td><b>Year Level: </b> <?php echo $year_level ?></td>
                <?php } elseif ($userType == 'Highschool') { ?>
                    <td><b>Age: </b> <?php echo $age ?></td>
                    <td><b>Sex: </b> <?php echo ucfirst($sex) ?></td>
                    <td><b>Course: </b> <?php echo $courseName ?></td>
                    <td><b>Year Level: </b> <?php echo $year_level ?></td>
                <?php } elseif ($userType == 'Senior High School') { ?>
                    <td><b>Age: </b> <?php echo $age ?></td>
                    <td><b>Sex: </b> <?php echo ucfirst($sex) ?></td>
                    <td><b>Grade Level: </b> <?php echo $grade_level ?></td>
                    <td><b>Track Strand and Section: </b> <?php echo $track_strand_patient?> - <?php echo $section_patient ?></td>
    ...
    <b>Religion: </b> 
    <?php 
        // Clean up "Other"/"Others" prefixes in any case or spacing
        echo htmlspecialchars(preg_replace('/^others?\s*:\s*/i', '', trim($religion)));
    ?>
</td>
                ...
                <div class="container" style="margin-left: 25px; margin-top: 10px;">
                    ...
                    <div class="checkbox-line">
                     ...
                     <div class="checkbox-line">
                       ...
                       <span class="checkbox-fake <?php if (in_array('other', $menstrual_symptoms)) echo 'checked'; ?>"></span>Other: <?php echo !empty($menstrual_symptoms_map['other']) ? htmlspecialchars($menstrual_symptoms_map['other']) : '__________________________________'; ?>
  ...
  <table class="main-table" style="margin-top: 25px; border-collapse: collapse; width: 100%;" border="1">
            ...
            <tr class="consultation-row">
                ...
                <td style="text-align: center;">
                    <p style="border-bottom: 1px solid black; width: 100%;">
                        <b>HR:</b> <?php echo htmlspecialchars($consultation['heart_rate'] ?? 'N/A'); ?>
                    </p>
                    <p style="border-bottom: 1px solid black; width: 100%;">
                        <b>RR:</b> <?php echo htmlspecialchars($consultation['respiratory_rate'] ?? 'N/A'); ?>
                    </p>
                    <p style="border-bottom: 1px solid black; width: 100%;">
                        <b>Temp:</b> <?php echo htmlspecialchars($consultation['temperature'] ?? 'N/A'); ?>°C
                    </p>
                    <p style="border-bottom: 1px solid black; width: 100%;">
                        <b>O2 Sat:</b> <?php echo htmlspecialchars($consultation['oxygen_saturation'] ?? 'N/A'); ?>
                    </p>
                    <p style="width: 100%;">
                        <b>BP:</b> <?php echo htmlspecialchars($consultation['blood_pressure'] ?? 'N/A'); ?>
                    </p>
                </td>
                ...
                <td style="text-align: center;">
                    <?php if (!empty($consultation['staff_signature'])): ?>
                        <img src="<?= htmlspecialchars($consultation['staff_signature']) ?>" alt="Signature" style="max-width:150px; height:auto;">
                    <?php else: ?>
                        <span>No signature</span>
                    <?php endif; ?>

                    <br><br>
                    <?php echo htmlspecialchars($consultation['staff_name'] ?? 'N/A'); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else: ?>
        <tr>
            <td colspan="7" style="text-align: center; padding: 20px; color: gray;  text-transform: uppercase;">
                <b>No consultation records found.</b>
            </td>
        </tr>
    <?php endif; ?>
</table>
        ...
        <center>
            <h3 style="color: darkred"><i>(For use by the University Health Services Center, please do not fill beyond this
                    point.)</i></h3>
        </center>
        ...
        <table class="main-table" style="margin-top: 25px; border-collapse: collapse; width: 100%;" border="1">
            <tr>
                <td colspan="6" style="background-color: #8B0000; color: white; padding: 10px; text-align: center;">
                    <b>PHYSICAL RECORD</b>
                </td>
            </tr>
            <tr>
                ...
                <td><input type="number" id="height" name="height" oninput="calculateBMI()"></td>
                <td><b>Weight (kg):</b></td>
                <td><input type="number" id="weight" name="weight" oninput="calculateBMI()"></td>
                <td><b>BMI:</b></td>
                <td>
                    <input type="text" id="bmi" name="bmi" readonly> <br> <span id="bmiLabel" class="status-label"></span>
                </td>
            ...
            <tr>
                <td colspan="6">
                    ...
                    <textarea class="text-area" maxlength="5000"></textarea>
            ...
            <tr>
                <td colspan="5"> <b>Chest X-ray Results:</b></td>
                <td>
                    <select name="chest_xray" class="status-select" onchange="updateStatusColor(this)">
            ...
            <tr>
                <td colspan="5"><b>CBC Results:</b></td>
                <td>
                    <select name="cbc" class="status-select" onchange="updateStatusColor(this)">
                        <option value="">-- Select --</option>
                        <option value="PASSED">PASSED</option>
                        <option value="FAILED">FAILED</option>
                        <option value="NOT REQUIRED">NOT REQUIRED</option>
            ...
            <tr>
                <td colspan="5"><b>Hepatitis B Screening Results (Antigen Test):</b></td>
                <td>
                    <select name="hepatitis" class="status-select" onchange="updateStatusColor(this)">
                        <option value="">-- Select --</option>
                        <option value="PASSED">PASSED</option>
                        <option value="FAILED">FAILED</option>
                        <option value="NOT REQUIRED">NOT REQUIRED</option>
            ...
            <tr>
                <td colspan="5"><b>Urinalysis Results:</b></td>
                <td>
                    <select name="urinalysis" class="status-select" onchange="updateStatusColor(this)">
                        <option value="">-- Select --</option>
                        <option value="PASSED">PASSED</option>
                        <option value="FAILED">FAILED</option>
                        <option value="NOT REQUIRED">NOT REQUIRED</option>
            ...
            <section>
                <tr>
                    <td colspan="6">
                        <span id="reqText">
                            <center>
                                <h1 style="text-align: center; color: orange">NO OTHER TESTS REQUIRED</h1>
                            </center>
                        </span>
                        <b id="othersText">Others:</b>
                        <table class="others-table" id="othersTable">
                        </table>
                        <button type="button" id="addOther" onclick="addOtherRow()">+ Add Other Tests</button>
                    </td>
                </tr>
            </section>
            ...
            <script>
                function calculateBMI() {
                    ...
                    bmiField.className = "";
                    bmiLabel.className = "status-label";
                    ...
                    if (height > 0 && weight > 0) {
                        ...
                        if (bmi < 18.5) {
                            bmiField.classList.add("bmi-warning");
                            bmiLabel.textContent = "Underweight";
                            bmiLabel.classList.add("bmi-warning");
                        } else if (bmi >= 18.5 && bmi <= 24.9) {
                            bmiField.classList.add("bmi-normal");
                            ...
                            bmiField.classList.add("bmi-danger");
                            bmiLabel.textContent = "Obese";
                            bmiLabel.classList.add("bmi-danger");
                        }
                    } else {
                        bmiField.value = "";
                ...
                function updateStatusColor(select) {
                    select.classList.remove("status-passed", "status-failed", "status-notrequired");

                    if (select.value === "PASSED") {
                        select.classList.add("status-passed");
                    } else if (select.value === "FAILED") {
                        select.classList.add("status-failed");
                    } else if (select.value === "NOT REQUIRED") {
                        select.classList.add("status-notrequired");
                    }
                }

                function addOtherRow() {
                    const hiddenText = document.getElementById("othersText");
                    hiddenText.style.display = "block"; // change the ID
                    ...
                    hiddenText.id.textContent = "properText";

                    const nameCell = row.insertCell(0);
                    const statusCell = row.insertCell(1);
                    const actionCell = row.insertCell(2);
                    actionCell.classList.add("no-print"); // mark the whole cell
                    actionCell.innerHTML = `<button type="button" onclick="deleteRow(this)">🗑️ Delete</button>`;


                    nameCell.innerHTML = `<input type="text" name="others_name[]" placeholder="Enter test name">`;
                    statusCell.innerHTML = `
                    <center>
        <select name="others_status[]" class="status-select" onchange="updateStatusColor(this)">
            <option value="">-- Select --</option>
            <option value="PASSED">PASSED</option>
            <option value="FAILED">FAILED</option>
            <option value="NOT REQUIRED">NOT REQUIRED</option>
    ...
    `;
                    actionCell.innerHTML = `<button type="button" onclick="deleteRow(this)" class="no-print">🗑️ Delete</button>`;
