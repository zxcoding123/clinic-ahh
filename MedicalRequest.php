...
if ($action === 'book_appointment' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ✅ Send notifications to Super Admin and Medical Admin
 ...
 elseif ($user_type === "Employee") {
    ...
    ";
                ...
                <?php if ($isStudent): ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger mt-3">
                            You already have a medical appointment this semester
                ...
                <?php elseif ($user_type === "Employee"): ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-danger mt-3">
                            You have already reached the maximum of 3 medical consultations for this week
                            (<?php echo $week_start; ?> to <?php echo $week_end; ?>).
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
