            ...
            <div class="photo-cell-container">
                <div class="photo-cell">
                    ...
                    <?php if ($photo_path && file_exists($full_photo_path)): ?>
                        <img src="<?php echo htmlspecialchars($full_photo_path); ?>" alt="<?php echo $child_id ? 'Child Photo' : 'Patient Photo'; ?>">
                    <?php else: ?>
                        <span>(Photo of Patient)</span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="personal-info-table">
                <table>
                    ...
                    if ($userType === 'Senior High School') {
                        ...
                        echo '<tr>';
                        echo '<td colspan="4"><span class="text-muted">No educational details available</span></td>';
                        echo '</tr>';
                    }
                    ?>
                    <tr>
