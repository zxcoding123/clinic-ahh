...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $familyHistory = isset($_POST['family_history']) ? (array)$_POST['family_history'] : [];
        if (in_array('Cancer', $familyHistory) && !empty($_POST['cancer_type_specify'])) {
            $cancerSpec = 'Cancer: ' . sanitizeInput($_POST['cancer_type_specify']);
            $familyHistory = array_diff($familyHistory, ['Cancer']);
            $familyHistory[] = $cancerSpec;
        }
        if (in_array('Allergies', $familyHistory) && !empty($_POST['family_allergy_specify'])) {
            $allergySpec = 'Allergies: ' . sanitizeInput($_POST['family_allergy_specify']);
            $familyHistory = array_diff($familyHistory, ['Allergies']);
            $familyHistory[] = $allergySpec;
        }
        ...
        $medicalData = [
            ...
            'menstrual_symptoms' => isset($_POST['symptoms']) ? implode(",", array_map('sanitizeInput', (array)$_POST['symptoms'])) : null,
...
");
        ...
        $notificationLink = "wmsu/patient-profile.php";
            ...
            <div id="upperSections">
                <fieldset class="form-section">
                    ...
                    <div class="personal-info-grid">
                        ...
                        <div class="form-group">
                            <div class="input-wrapper">
                                <label for="studentId">Student ID: <small>(N/A if none)</small></label>
                ...
                <fieldset class="form-section">
                    ...
                    <div class="checkbox-grid">
                        <div class="checkbox-column">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="illness[]" value="irritable_bowel_syndrome">
                        ...
                        <div class="checkbox-column">
                            <label class="checkbox-label">
                                ...
                                <div class="nested-checkboxes">
                                    ...
                                    <label class="checkbox-label nested">
                                        <input type="checkbox" name="psychiatric[]" value="bipolar">
                                        Bipolar Disorder
                                    </label>
                                    <label class="checkbox-label nested">
                                    ...
                                    <label class="checkbox-label nested">
                                        <input type="checkbox" name="psychiatric[]" value="panic">
                                        Panic Disorder
                                    </label>
                                    <label class="checkbox-label nested">
                                        <input type="checkbox" name="psychiatric[]" value="stress">
                                        Posttraumatic Stress Disorder
                                    </label>
                                    <label class="checkbox-label nested">
                                        <input type="checkbox" name="psychiatric[]" value="schizophrenia">
                                        Schizophrenia
                                    </label>
                                </div>
                            </label>
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="illness[]" value="diabetes_mellitus">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="illness[]" value="cancer">
                                Cancer
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="illness[]" value="other">
                                Other:
                                <input type="text" placeholder="Specify" name="otherIllness" class="inline-input">
                            </label>
                        </div>
                    </div>
                ...
                <fieldset class="form-section">
                    ...
                    <div class="checkbox-grid">
                        ...
                        <div class="checkbox-column">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="past_illness[]" value="Stab/Laceration">
                                Stab/Laceration
                            </label>
                            <label class="checkbox-label">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="otherPastIllnessInput" name="other_past_illness" placeholder="Specify other illnesses" style="display: none; width: 300px; margin-top: 5px;">
                    </div>
                </fieldset>
                ...
                <fieldset class="form-section">
                    ...
                    <div class="checkbox-grid">
                        <div class="checkbox-column">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Coronary Artery Disease">
                                Coronary Artery Disease
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Congestive Heart Failure">
                                Congestive Heart Failure
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Diabetes Mellitus">
                                Diabetes Mellitus (Elevated Blood Sugar)
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Chronic Kidney Disease">
                                Chronic Kidney Disease (With/Without Hemodialysis)
                            </label>
                        </div>
                        <div class="checkbox-column">
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Cancer">
                                Cancer (Any Type)
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="cancerCheckbox" onclick="toggleCancerInput()">
                                Cancer - Specify Type
                            </label>
                            <input type="text" class="form-control d-none" id="cancerInput" name="cancer_type_specify" placeholder="Specify cancer type" style="margin-top: 5px;">
                            <label class="checkbox-label">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Tuberculosis">
                                Tuberculosis
                            </label>
                        </div>
                        <div class="checkbox-column">
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Mental Illness">
                                Mental Illness (Depression, Schizophrenia, etc.)
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Liver Disease">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Blood Disorder">
                                Blood Disorder (Anemia, Hemophilia, etc.)
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" id="allergyCheckbox" onclick="toggleAllergyInput()">
                                Allergies - Specify
                            </label>
                            <input type="text" class="form-control d-none" id="allergyInput" name="family_allergy_specify" placeholder="Specify allergies" style="margin-top: 5px;">
                            <label class="checkbox-label">
                                <input type="checkbox" id="otherFamilyCheckbox" onclick="toggleOtherFamilyInput()">
                                Other (Specify)
                            </label>
                            <input type="text" class="form-control d-none" id="otherFamilyInput" name="other_family_history" placeholder="Specify other conditions" style="margin-top: 5px;">
                        </div>
                    </div>
                </fieldset>
