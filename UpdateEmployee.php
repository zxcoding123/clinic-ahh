...
";
    ...
    INSERT INTO patients_history (
        user_id,  surname, firstname, middlename, suffix, 
...
WHERE user_id = ?";
        ...
        $stmt->bind_param(
            "sssssissssssssssssssssssssssi", // Notice the last 'i' for user_id
...
foreach ($menstrualSymptoms as $i => $symptom) {
    ...
    if (stripos($symptom, 'other:') === 0) {
        ...
        $menstrualSymptoms[$i] = 'other'; // keep checkbox value as just "other"
    }
}
...
<body>
    ...
    <div class="mainContainer">
        <form class="health-profile-form" id="healthProfileForm" action="updateemployee.php" method="POST" enctype="multipart/form-data">
            ...
            <div id="upperSections">
                <fieldset class="form-section">
                    ...
                    <div class="photo-upload-section">
                        <label for="studentPhoto">Photo of Employee</label>
                ...
                <fieldset class="form-section">
                    ...
                    <div class="checkbox-grid">
                        ...
                        <div class="checkbox-column">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="illness[]" value="cancer" onchange="toggleExtra(this, 'cancer-input')" <?= isChecked('illnesses', 'cancer') ?>>
                                Cancer
                            </label>
...
HTML;
                ...
                <fieldset class="form-section">
                    ...
                    <div class="checkbox-grid">
                        ...
                        <div class="checkbox-column">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="sle" <?= isChecked('family_history', 'sle') ?>>
                                Systemic Lupus Erythematosus (SLE)
                            </label>
                            <label class="checkbox-label">
    ...
    <script src="js/form_employee_update.js"></script>
