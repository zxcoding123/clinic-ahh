...
foreach ($familyHistory as $item) {
    $item = trim($item);
    if (stripos($item, 'Other:') === 0) {
        $otherFamilyCondition = trim(substr($item, strlen('Other:')));
    } elseif (stripos($item, 'Allergies:') === 0) {
        $familyAllergy = trim(substr($item, strlen('Allergies:')));
                    ...
                    <div class="personal-info-grid">
                        ...
                        <div class="form-group">
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="studentId" name="studentId" value="<?= formValue('student_id') ?>" required>
                        ...
                        <div class="form-group">
                            <div class="input-wrapper">
                                ...
                                <select id="emergencyRelationship" name="emergencyRelationship" required onchange="toggleOtherRelationshipInput()">
                                    ...
                                    <?php $relationship = $emergencyContactData['relationship'] ?? ''; ?>
    ...
    <div class="checkbox-column">
        ...
        <label class="checkbox-label">
            <input type="checkbox" name="illness[]" value="allergies" id="allergiesCheckbox"
                <?= in_array('allergies', $checkedIllnesses) ? 'checked' : '' ?>>
            Food Allergies
            <div id="allergiesSpecifyContainer" style="<?= in_array('allergies', $checkedIllnesses) ? '' : 'display: none;' ?>">
                <input
                    type="text"
        ...
        <label class="checkbox-label">
            <input type="checkbox" name="illness[]" value="irritable_bowel_syndrome" <?= isChecked('illnesses', 'irritable_bowel_syndrome') ?>>
    ...
    <div class="checkbox-column">
        <label class="checkbox-label">
            ...
            <div class="nested-checkboxes">
                ...
                <label class="checkbox-label nested">
                    <input type="checkbox" name="psychiatric[]" value="stress" <?= isChecked('illnesses', 'stress') ?>>
        ...
        <label class="checkbox-label">
            <input type="checkbox" name="illness[]" value="diabetes_mellitus" <?= isChecked('illnesses', 'diabetes_mellitus') ?>>
        ...
        <label class="checkbox-label">
            <input type="checkbox" name="illness[]" value="sle" <?= isChecked('illnesses', 'sle') ?>>
                    ...
                    <div class="menstrual-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                ...
                                <label class="checkbox-label">
                                    <input type="checkbox" name="symptoms[]" value="other" <?= isChecked('menstrual_symptoms', 'other') ?>>
                                    Other:
                ...
                <fieldset class="form-section">
                    ...
                    <div class="checkbox-grid">
                        ...
                        <div class="checkbox-column">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="past_illness[]" value="Stab/Laceration" <?= isChecked('past_illnesses', 'Stab/Laceration') ?>>
                                Stab/Laceration
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="past_illness[]" value="Fracture" <?= isChecked('past_illnesses', 'AmoeFracturebiasis') ?>>
                                Fracture
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="otherPastIllnessInput" name="other_past_illness"
                ...
                <fieldset class="form-section">
                    ...
                    <div class="checkbox-grid">
                        <div class="checkbox-column">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Coronary Artery Disease" <?= isChecked('family_history', 'Coronary Artery Disease') ?>>
                                Coronary Artery Disease
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Congestive Heart Failure" <?= isChecked('family_history', 'Congestive Heart Failure') ?>>
                                Congestive Heart Failure
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Diabetes Mellitus" <?= isChecked('family_history', 'Diabetes Mellitus') ?>>
                                Diabetes Mellitus (Elevated Blood Sugar)
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Chronic Kidney Disease" <?= isChecked('family_history', 'Chronic Kidney Disease') ?>>
                        ...
                        <div class="checkbox-column">
                            ...
                            <input type="text" class="form-control" id="cancerInput" name="cancer_type_specify"
                        ...
                        <div class="checkbox-column">
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Mental Illness" <?= isChecked('family_history', 'Mental Illness') ?>>
                                Mental Illness (Depression, Schizophrenia, etc.)
                            </label>
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Liver Disease" <?= isChecked('family_history', 'Liver Disease') ?>>
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" name="family_history[]" value="Blood Disorder" <?= isChecked('family_history', 'Blood Disorder') ?>>
