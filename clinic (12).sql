...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2025 at 12:20 PM
...
(163, 113, NULL, 'check-up', '2025-09-09', '14:00:00', 'Cancelled', 'dental', '2022-2023', '1st Semester', '1', '2025-09-09 05:15:04', '2025-09-15 10:18:02'),
(164, 113, NULL, 'check-up', '2025-09-16', '08:00:00', 'Pending', 'medical', '2022-2023', '1st Semester', '1', '2025-09-15 10:16:19', '2025-09-15 10:16:19');
...
INSERT INTO `children` (`id`, `parent_id`, `last_name`, `first_name`, `middle_name`, `type`, `id_path`, `created_at`, `patient_id`) VALUES
(38, 118, 'Gusion', 'Gusion', 'Gusion', 'Kindergarten', 'Uploads/documents/68c7e02e9fa68_7cefebd44daea65a8845f6a85fbe184e__1__-_Copy.jpg', '2025-09-15 09:45:18', 220);
...
INSERT INTO `consent_forms` (`id`, `parent_name`, `child_name`, `residence`, `consent_procedure`, `witness_printed_name`, `parent_printed_name`, `patient_printed_name`, `witness_date`, `parent_date`, `patient_date`, `witness_signature`, `parent_signature`, `patient_signature`, `created_at`) VALUES
(2, 'asd', 'gusion', 'asd', 'asd', 'ouifhasofuahs', 'asfasfasfa', 'asfasfasf', '2025-09-15', '2025-09-15', '2025-09-15', 'signatures/witness_1757931072.png', 'signatures/parent_1757931072.png', 'signatures/patient_1757931072.png', '2025-09-15 10:11:12');
...
(133, 163, 113, NULL, 23, '2025-09-15', '07:02:19', 'medical', '2025-09-14 23:02:19', '2025-09-14 23:05:59', 'pending');
...
(23, '28ea8913fe575f6dfd4cf0bb731a25466770bdb70a9da4e4983c7598fa3428ea', '2025-09-15 18:17:50');
...
(212, 220, 'PARENT', 'PARENT', 'PARENT', '09536640199', 'OTHER: Gusion', 'Gusion', '2025-09-15 09:48:30');
...
INSERT INTO `medical_documents` (`id`, `user_id`, `child_id`, `document_type`, `file_path`, `original_file_name`, `request_type`, `reason`, `competition_scope`, `status`, `submitted_at`, `created_at`, `updated_at`) VALUES
(213, 118, NULL, 'medical_certificate', NULL, NULL, 'non-ojt', 'school-competition', 'local', 'pending', '2025-09-15 10:11:49', '2025-09-15 10:11:49', '2025-09-15 10:11:49'),
(214, 113, NULL, 'medical_certificate', '../Uploads/medical_documents/med_cert_113_1757931298.png', 'citizenship_252x165.png', 'ojt-internship', 'internship-requirement', NULL, 'pending', '2025-09-15 10:14:58', '2025-09-15 10:14:58', '2025-09-15 10:14:58');
...
(210, 220, 'asthma, Allergies: peanut butter, shrimp, rhinitis, hyperthyroidism, hypothyroidism, anemia, migraine, epilepsy, gerd, bowel_syndrome, psychiatric, depression, bipolar, anxiety, panic, ptsd, schizophrenia, lupus, hypertension, diabetes, dyslipidemia, arthritis, pcos, Cancer: penis, Other: penis, psychiatric,depression,bipolar,anxiety,panic,ptsd,schizophrenia,Other Mental Illness: test', 'paracetamol: 1 mg', 'fully', NULL, '', NULL, NULL, NULL, 'varicella, dengue, tuberculosis, pneumonia, UTI, appendicitis, Cholecystitis, measles, typhoid fever, amoebiasis, injury, burn, stab, fracture, Other: not getting detected', '2000: removal of penis', 'hypertension, congestive, diabetes, chronic_kidney, copd, gerd, bowel_syndrome, epilepsy, stroke, asthma, tuberculosis, rhinitis, hyperthyroidism, hypothyroidism, anemia, migraine, psychiatric, depression, bipolar, anxiety, panic, ptsd, schizophrenia, liver_disease, arthritis, blood_disorder, dyslipidemia, pcos, lupus', NULL, '2025-09-15 09:48:30', '2025-09-15 09:48:30');
...
(408, 23, 'waiver_submission', 'Dental Appointment Request', 'TEST TEST TEST has requested for a dental appointment!', '#', 'read', '2025-08-31 20:50:30', '2025-09-15 06:55:22'),
...
(410, 23, 'health_profile_submission', 'Health Profile Updated!', 'Test Test - (College) has updated their health profile.', 'patient-profile.php', 'read', '2025-08-31 21:02:45', '2025-09-15 06:55:22'),
...
(413, 23, 'health_profile_submission', 'New Health Profile Submission!', 'Employee Employee (Employee) has submitted their health profile', 'patient-profile.php', 'read', '2025-08-31 21:08:18', '2025-09-15 06:55:22'),
...
(416, 23, 'waiver_submission', 'New Waiver Submission', 'Employee, Employee has signed a waiver.', '#', 'read', '2025-08-31 21:08:26', '2025-09-15 06:55:22'),
...
(419, 23, 'health_profile_submission', 'New Health Profile Submission!', 'Aamon Aamon (Elementary Student) has submitted their health profile', 'patient-profile.php', 'read', '2025-08-31 21:25:42', '2025-09-15 06:55:22'),
...
(422, 23, 'waiver_submission', 'New Waiver Submission', 'Parent, Parent has signed a waiver.', '#', 'read', '2025-08-31 21:28:40', '2025-09-15 06:55:22'),
...
(425, 23, 'medical_certificate_submission', 'New Medical Certificate Submission', 'Parent Parent (Parent) has submitted a medical certificate', 'medical-documents.php', 'read', '2025-08-31 21:29:15', '2025-09-15 06:55:22'),
...
(428, 23, 'medical_certificate_submission', 'New Medical Certificate Submission', 'Parent Parent (Parent) has submitted a medical certificate', 'medical-documents.php', 'read', '2025-08-31 21:29:52', '2025-09-15 06:55:22'),
...
(431, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:08:01', '2025-09-15 06:55:22'),
...
(434, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:11:03', '2025-09-15 06:55:22'),
...
(437, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:12:48', '2025-09-15 06:55:22'),
...
(440, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:19:15', '2025-09-15 06:55:22'),
...
(443, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:22:34', '2025-09-15 06:55:22'),
...
(446, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:27:10', '2025-09-15 06:55:22'),
...
(449, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:30:49', '2025-09-15 06:55:22'),
...
(452, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:42:58', '2025-09-15 06:55:22'),
...
(455, 23, 'health_profile_submission', 'New Health Profile Submission!', 'College guy College guy (College) has submitted their health profile', 'patient-profile.php', 'read', '2025-09-01 22:45:06', '2025-09-15 06:55:22'),
...
(458, 23, 'health_profile_submission', 'Health Profile Updated!', '213 Asd - (College) has updated their health profile.', 'patient-profile.php', 'read', '2025-09-01 22:50:20', '2025-09-15 06:55:22'),
...
(461, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-07 01:31:51', '2025-09-15 06:55:22'),
...
(463, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-07 01:36:07', '2025-09-15 06:55:22'),
...
(465, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-07 01:42:25', '2025-09-15 06:55:22'),
...
(467, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-07 01:46:15', '2025-09-15 06:55:22'),
...
(469, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-07 01:50:35', '2025-09-15 06:55:22'),
...
(471, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-07 01:51:14', '2025-09-15 06:55:22'),
...
(473, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-07 12:43:32', '2025-09-15 06:55:22'),
...
(475, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-07 14:21:06', '2025-09-15 06:55:22'),
...
(477, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-07 14:45:18', '2025-09-15 06:55:22'),
...
(479, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-08 20:40:53', '2025-09-15 06:55:22'),
...
(481, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 20:53:23', '2025-09-15 06:55:22'),
...
(483, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 20:59:03', '2025-09-15 06:55:22'),
...
(485, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 21:03:22', '2025-09-15 06:55:22'),
...
(487, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-08 21:05:00', '2025-09-15 06:55:22'),
...
(489, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'read', '2025-09-08 21:05:05', '2025-09-15 06:55:22'),
...
(491, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 21:13:02', '2025-09-15 06:55:22'),
...
(493, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 21:22:34', '2025-09-15 06:55:22'),
...
(495, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 21:39:08', '2025-09-15 06:55:22'),
...
(497, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 21:46:13', '2025-09-15 06:55:22'),
...
(499, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-08 21:46:18', '2025-09-15 06:55:22'),
...
(501, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 02:11:14', '2025-09-15 06:55:22'),
...
(503, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 02:12:37', '2025-09-15 06:55:22'),
...
(505, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 02:21:31', '2025-09-15 06:55:22'),
...
(507, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 02:34:52', '2025-09-15 06:55:22'),
...
(509, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 03:42:53', '2025-09-15 06:55:22'),
...
(511, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 03:46:26', '2025-09-15 06:55:22'),
...
(513, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 03:46:33', '2025-09-15 06:55:22'),
...
(515, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 03:47:57', '2025-09-15 06:55:22'),
...
(517, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 03:48:49', '2025-09-15 06:55:22'),
...
(519, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 03:49:53', '2025-09-15 06:55:22'),
...
(521, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 04:14:12', '2025-09-15 06:55:22'),
...
(523, 23, 'waiver_submission', 'Dental Appointment Cancellation', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has canelled the dental appointment!', '#', 'read', '2025-09-09 04:20:47', '2025-09-15 06:55:22'),
...
(525, 23, 'waiver_submission', 'Dental Appointment Cancellation', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has canelled the dental appointment!', '#', 'read', '2025-09-09 04:20:53', '2025-09-15 06:55:22'),
...
(527, 23, 'waiver_submission', 'Dental Appointment Cancellation', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has canelled the dental appointment!', '#', 'read', '2025-09-09 04:20:56', '2025-09-15 06:55:22'),
...
(529, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 04:22:37', '2025-09-15 06:55:22'),
...
(531, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 04:22:47', '2025-09-15 06:55:22'),
...
(533, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 04:22:52', '2025-09-15 06:55:22'),
...
(535, 23, 'waiver_submission', 'Dental Appointment Cancellation', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has canelled the dental appointment!', '#', 'read', '2025-09-09 04:23:00', '2025-09-15 06:55:22'),
...
(537, 23, 'waiver_submission', 'Dental Appointment Cancellation', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has canelled the dental appointment!', '#', 'read', '2025-09-09 04:23:03', '2025-09-15 06:55:22'),
...
(539, 23, 'waiver_submission', 'Dental Appointment Cancellation', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has canelled the dental appointment!', '#', 'read', '2025-09-09 04:23:05', '2025-09-15 06:55:22'),
...
(541, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 12:59:45', '2025-09-15 06:55:22'),
(542, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 12:59:45', '2025-09-09 12:59:45'),
(543, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:00:02', '2025-09-15 06:55:22'),
(544, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:00:02', '2025-09-09 13:00:02'),
(545, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:00:05', '2025-09-15 06:55:22'),
(546, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:00:05', '2025-09-09 13:00:05'),
(547, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:00:07', '2025-09-15 06:55:22'),
(548, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:00:07', '2025-09-09 13:00:07'),
(549, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:00:11', '2025-09-15 06:55:22'),
(550, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:00:11', '2025-09-09 13:00:11'),
(551, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:00:14', '2025-09-15 06:55:22'),
(552, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:00:14', '2025-09-09 13:00:14'),
(553, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:00:16', '2025-09-15 06:55:22'),
(554, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:00:16', '2025-09-09 13:00:16'),
(555, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:00:20', '2025-09-15 06:55:22'),
(556, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:00:20', '2025-09-09 13:00:20'),
(557, 23, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'read', '2025-09-09 13:15:04', '2025-09-15 06:55:22'),
(558, 25, 'waiver_submission', 'Dental Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a dental appointment!', '#', 'unread', '2025-09-09 13:15:04', '2025-09-09 13:15:04'),
(559, 23, 'health_profile_submission', 'New Health Profile Submission!', 'Gusion Gusion (Elementary Student) has submitted their health profile', 'patient-profile.php', 'unread', '2025-09-15 17:48:30', '2025-09-15 17:48:30'),
(560, 24, 'health_profile_submission', 'New Health Profile Submission!', 'Gusion Gusion (Elementary Student) has submitted their health profile', 'patient-profile.php', 'unread', '2025-09-15 17:48:30', '2025-09-15 17:48:30'),
(561, 25, 'health_profile_submission', 'New Health Profile Submission!', 'Gusion Gusion (Elementary Student) has submitted their health profile', 'patient-profile.php', 'unread', '2025-09-15 17:48:30', '2025-09-15 17:48:30'),
(562, 23, 'waiver_submission', 'New Waiver Submission', 'PARENT, PARENT has signed a waiver.', '#', 'unread', '2025-09-15 18:11:44', '2025-09-15 18:11:44'),
(563, 24, 'waiver_submission', 'New Waiver Submission', 'PARENT, PARENT has signed a waiver.', '#', 'unread', '2025-09-15 18:11:44', '2025-09-15 18:11:44'),
(564, 25, 'waiver_submission', 'New Waiver Submission', 'PARENT, PARENT has signed a waiver.', '#', 'unread', '2025-09-15 18:11:44', '2025-09-15 18:11:44'),
(565, 23, 'medical_certificate_submission', 'New Medical Certificate Submission', 'PARENT PARENT (Parent) has submitted a medical certificate', 'medical-documents.php', 'unread', '2025-09-15 18:11:49', '2025-09-15 18:11:49'),
(566, 24, 'medical_certificate_submission', 'New Medical Certificate Submission', 'PARENT PARENT (Parent) has submitted a medical certificate', 'medical-documents.php', 'unread', '2025-09-15 18:11:49', '2025-09-15 18:11:49'),
(567, 25, 'medical_certificate_submission', 'New Medical Certificate Submission', 'PARENT PARENT (Parent) has submitted a medical certificate', 'medical-documents.php', 'unread', '2025-09-15 18:11:49', '2025-09-15 18:11:49'),
(568, 23, 'waiver_submission', 'New Waiver Submission', 'COLLEGE GUY, COLLEGE GUY has signed a waiver.', '#', 'unread', '2025-09-15 18:14:52', '2025-09-15 18:14:52'),
(569, 24, 'waiver_submission', 'New Waiver Submission', 'COLLEGE GUY, COLLEGE GUY has signed a waiver.', '#', 'unread', '2025-09-15 18:14:52', '2025-09-15 18:14:52'),
(570, 25, 'waiver_submission', 'New Waiver Submission', 'COLLEGE GUY, COLLEGE GUY has signed a waiver.', '#', 'unread', '2025-09-15 18:14:52', '2025-09-15 18:14:52'),
(571, 23, 'medical_certificate_submission', 'New Medical Certificate Submission', '213 Asd (College) has submitted a medical certificate', 'medical-documents.php', 'unread', '2025-09-15 18:14:58', '2025-09-15 18:14:58'),
(572, 24, 'medical_certificate_submission', 'New Medical Certificate Submission', '213 Asd (College) has submitted a medical certificate', 'medical-documents.php', 'unread', '2025-09-15 18:14:58', '2025-09-15 18:14:58'),
(573, 25, 'medical_certificate_submission', 'New Medical Certificate Submission', '213 Asd (College) has submitted a medical certificate', 'medical-documents.php', 'unread', '2025-09-15 18:14:58', '2025-09-15 18:14:58'),
(574, 23, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'unread', '2025-09-15 18:16:19', '2025-09-15 18:16:19'),
(575, 24, 'waiver_submission', 'Medical Appointment Request', 'COLLEGE GUY COLLEGE GUY COLLEGE GUY has requested for a medical appointment!', '#', 'unread', '2025-09-15 18:16:19', '2025-09-15 18:16:19');
...
INSERT INTO `parents` (`id`, `user_id`, `id_path`, `created_at`) VALUES
(22, 118, 'Uploads/documents/68c7e02e9beeb_7cefebd44daea65a8845f6a85fbe184e__1__-_Copy.jpg', '2025-09-15 09:45:18');
...
(219, 118, NULL, 'PARENT', 'PARENT', 'PARENT', NULL, '1970-01-01', 30, 'male', 'unknown', NULL, 'Filipino', 'single', 'parent@gmail.com', 'PARENT_ACC', 'Unknown', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-15 09:45:18', '2025-09-15 09:45:18'),
(220, 118, '2020-01524', 'Gusion', 'Gusion', 'Gusion', '', '2002-07-20', 23, 'male', 'B+', 'OTHER: asd', 'Filipino', 'single', 'parent@gmail.com', '09302470132', 'Gusion', 'Gusion', 'uploads/student_photos/19bde65cc4321e5caba6c020529a6849.png', 'kinder1', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-09-15 09:48:30', '2025-09-15 09:48:30');
...
(23, 'Admin', 'Super', NULL, 'superadmin@gmail.com', '$2y$10$X2VI14OzWKQNdOI6AUSmueUI9XqXW/gD3vlYnnZX3tqxkOEpUxaVy', 'Super Admin', NULL, NULL, NULL, 1, '2025-05-02 19:23:11', '2025-05-03 03:23:11', NULL, NULL, NULL, NULL, 1, 0, 1),
...
(113, 'COLLEGE GUY', 'COLLEGE GUY', 'COLLEGE GUY', 'ahmadaquino.2002@gmail.com', '$2y$10$4P7cM.KC4ntOhAtNmD6aousHbbokrffAMTJ9TxIQHK3ULGZOCaN7W', 'College', NULL, NULL, NULL, 1, '2025-09-01 13:56:40', '2025-09-01 21:59:21', 'db60601712167cf4c44b2e2361b17547a40d85a781f016e72c75965b954a4353', '2025-10-15 18:14:46', NULL, NULL, 1, 0, 1),
...
(115, 'SENIOR HIGHER', 'SENIOR HIGHER', 'SENIOR HIGHER', 'seniorhigher@wmsu.edu.ph', '$2y$10$N0YRnREB3Du7goqXekP7POcRMDDk1dCCXNm4wZL04rCRbojNVGCCu', 'Senior High School', NULL, '4403f573da36d318cf6a6e31925e28d5d664f9d4a7d3146b51d441673a894703', '2025-09-01 22:00:47', 1, '2025-09-01 14:00:47', NULL, NULL, NULL, NULL, NULL, 0, 1, 1),
...
(118, 'PARENT', 'PARENT', 'PARENT', 'parent@gmail.com', '$2y$10$.YzlKJxc0pGEnMroTVEgvOQtHvLqS0JeV8ZFUWZum.Ilg3F4nq6rq', 'Parent', NULL, '1a86ce19d8242697ea1c7711f96a37c4043d705b4f7bb29057a75ff861869cdc', '2025-09-01 22:04:08', 1, '2025-09-01 14:04:08', '2025-09-01 21:59:21', NULL, NULL, NULL, NULL, 1, 0, 1);
...
(67, 113, 'profile_reminder', 'Profile Update Reminder', 'Please review and update your patient profile and account details to ensure they are accurate.', '', 'read', '2025-09-15 17:54:23', '2025-09-15 17:54:23'),
(68, 115, 'profile_reminder', 'Profile Update Reminder', 'Please review and update your patient profile and account details to ensure they are accurate.', '', 'unread', '2025-09-15 17:54:23', '2025-09-15 17:54:23'),
(69, 118, 'profile_reminder', 'Profile Update Reminder', 'Please review and update your patient profile and account details to ensure they are accurate.', '', 'unread', '2025-09-15 17:54:23', '2025-09-15 17:54:23'),
(70, 118, 'profile_reminder', 'Profile Update Reminder', 'Please review and update your patient profile and account details to ensure they are accurate.', '', 'unread', '2025-09-15 17:54:23', '2025-09-15 17:54:23');
...
INSERT INTO `waivers` (`id`, `user_id`, `full_name`, `signature_path`, `date_signed`, `created_at`, `updated_at`) VALUES
(59, 118, 'PARENT, PARENT PARENT', 'Uploads/signatures/signature_118_1757931104.png', '2025-05-14', '2025-09-15 10:11:44', '2025-09-15 10:11:44'),
(60, 113, 'COLLEGE GUY, COLLEGE GUY COLLEGE GUY', 'Uploads/signatures/signature_113_1757931292.png', '2025-05-14', '2025-09-15 10:14:52', '2025-09-15 10:14:52');
